...
//
// Orientation: home defends x=0 and attacks toward x=GRID_COLS (see
// resolve.ts's goalScoredAt). We want the player's goal near/at the bottom
// of the screen and the opponent's goal far/at the top, so the "depth" axis
// fed into the projection is (GRID_COLS - x), not x directly.
